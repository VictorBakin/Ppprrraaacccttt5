...
public class MovableObjects extends Circle implements Moving {
    ...
    public MovableObjects(double radius, double centralX, double centralY) {
        super(radius);
    ...
    public MovableObjects(double radius, double centralX, double centralY, String color, boolean filled) {
